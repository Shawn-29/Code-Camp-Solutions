/*
    ...
    00100000 01000110 01110010 01100101 01100101 01000011 01101111 01100100 
    01100101 01000011 01100001 01101101 01110000 00100001")

    should return the string "I love FreeCodeCamp!"
*/

const binaryAgent = (str) =>
    /* separate binary strings */
    str.split(' ').reduce((msg, binaryStr) =>
        /* parse a binary string into an integer code and then
            get the character representation of that integer code */
        msg + String.fromCharCode(parseInt(binaryStr, 2)), '');